// az deployment group create -g eus2rgplinkp01 -n databricks-test -f ./private-endpoint-databricks.bicep --parameters region=eastus2 resourceName=eus2cdbsmplintp01 resourceGroupName=eus2rgsmplintp01
