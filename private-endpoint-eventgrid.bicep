// az deployment group create -g eus2rgplinkp01 -n eventgrid-test -f ./private-endpoint-eventgrid.bicep --parameters region=eastus2 resourceName=eus2cdbsmplintp01 resourceGroupName=eus2rgsmplintp01
