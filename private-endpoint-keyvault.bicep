// az deployment group create -g eus2rgplinkp01 -n keyvault-test -f ./private-endpoint-keyvault.bicep --parameters region=eastus2 resourceName=eus2kvsmplintp01 resourceGroupName=eus2rgsmplintp01
