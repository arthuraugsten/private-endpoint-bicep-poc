// az deployment group create -g eus2rgplinkn01 -n databricks-test -f ./src/network/private-endpoints/private-endpoint-databricks.bicep --parameters location=eastus2 environment=n resourceName=eus2cdbsmplintd01 resourceGroupName=eus2rgsmplintd01
