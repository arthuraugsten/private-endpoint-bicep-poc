// az deployment group create -g eus2rgplinkn01 -n sqlserver-test -f ./src/network/private-endpoints/private-endpoint-sqlserver.bicep --parameters location=eastus2 environment=n resourceName=eus2kvsmplintd01 resourceGroupName=eus2rgsmplintd01
