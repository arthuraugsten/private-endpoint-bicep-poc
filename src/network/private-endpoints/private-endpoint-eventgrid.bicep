// az deployment group create -g eus2rgplinkn01 -n eventgrid-test -f ./src/network/private-endpoints/private-endpoint-eventgrid.bicep --parameters location=eastus2 environment=n resourceName=eus2cdbsmplintd01 resourceGroupName=eus2rgsmplintd01
...
resource resource 'Microsoft.EventGrid/domains@2022-06-15' existing = {
  name: resourceName
