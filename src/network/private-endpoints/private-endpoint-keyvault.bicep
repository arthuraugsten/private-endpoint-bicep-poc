// az deployment group create -g eus2rgplinkn01 -n keyvault-test -f ./src/network/private-endpoints/private-endpoint-keyvault.bicep --parameters location=eastus2 environment=n resourceName=eus2kvsmplintd01 resourceGroupName=eus2rgsmplintd01
