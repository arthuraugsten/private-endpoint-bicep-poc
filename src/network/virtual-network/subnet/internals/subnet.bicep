...
resource parentNetwork 'Microsoft.Network/virtualNetworks@2022-09-01' existing = {
  name: networkName
}

resource subnetDeploy 'Microsoft.Network/virtualNetworks/subnets@2022-09-01' = {
  name: subnetName
