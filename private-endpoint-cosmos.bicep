// az deployment group create -g eus2rgplinkp01 -n cosmos-test -f ./private-endpoint-cosmos.bicep --parameters region=eastus2 resourceName=eus2cdbsmplintp01 resourceGroupName=eus2rgsmplintp01
